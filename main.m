...
dataset=readtable('/Users/liangziting/Desktop/stock_data_new.csv');
risk_free_rate=readtable('/Users/liangziting/Desktop/shibor_weekly.xlsx');
...
%WHML: 0.9890 (p-value: 1.0008)
%WSMB: 0.5696 (p-value: 0.5920)
%MKT: -0.2608 (p-value: -0.2422)
%R-squared: 0.2769
...
%WHML: 0.9863 (p-value: 0.9942)
%WSMB: 0.5541 (p-value: 0.5631)
%MKT: -0.1836 (p-value: -0.1752)
%R-squared: 0.1714
...
%WHML: 1.0582 (p-value: 1.0668)
%WSMB: 0.4887 (p-value: 0.4981)
%MKT: -0.1917 (p-value: -0.1815)
%R-squared: 0.2967
...
turnover_12w_avg = movmean(final_dataset.num_trades, 12, 'Endpoints', 'discard');
% fill NaN
turnover_12w_avg = [NaN(11,1); turnover_12w_avg];
final_dataset.turnover_12w_avg = turnover_12w_avg;
final_dataset = rmmissing(final_dataset, 'DataVariables', 'turnover_12w_avg');
...
%-----------------------------------------------
%Intercept: 0.0286 (p-value: 0.0000)
%MKT: 1.0017 (p-value: 1.0146)
%WHML: -0.2346 (p-value: -0.2083)
%WSMB_new: 0.5942 (p-value: 0.6185)
%WPMO: 0.2419 (p-value: 0.2781)
%R-squared: 0.2773
%F-statistic: 12097.3678 (p-value: 0.0000)

%Mid-Pandemic Four-Factor Regression Results (4):
%-----------------------------------------------
%Intercept: 0.0223 (p-value: 0.0000)
%MKT: 0.9726 (p-value: 0.9814)
%WHML: -0.1105 (p-value: -0.1004)
%WSMB_new: 0.6018 (p-value: 0.6117)
%WPMO: 0.0790 (p-value: 0.0970)
%R-squared: 0.1721
%F-statistic: 20663.7082 (p-value: 0.0000)

%Post-Pandemic Four-Factor Regression Results (4):
%------------------------------------------------
%Intercept: 0.0230 (p-value: 0.0000)
%MKT: 1.0591 (p-value: 1.0676)
%WHML: -0.1610 (p-value: -0.1493)
%WSMB_new: 0.4841 (p-value: 0.4944)
%WPMO: 0.3387 (p-value: 0.3550)
%R-squared: 0.2997
%F-statistic: 29782.6189 (p-value: 0.0000)
